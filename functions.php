...
// Load utils.
require_once get_stylesheet_directory() . '/theme/utils/utils.php';
...
function catch_that_image() {
	...
	if ( empty( $first_img ) ) {
		// $first_img = 'https://classiceventsbuffalo.com/wp-content/uploads/2018/09/760x175.png';
		$first_img = null;
	}
	return $first_img;
}
...
function bones_register_sidebars() {
	...
	register_sidebar(
		array(
			'id'            => 'sidebar2',
			'name'          => __( 'Mobile Sidebar', 'bonestheme' ),
			'description'   => __( 'Sidebar to show when below 768.', 'bonestheme' ),
			'before_widget' => '<div id="%1$s" class="widget %2$s">',
			'after_widget'  => '</div>',
			'before_title'  => '<h4 class="widgettitle">',
			'after_title'   => '</h4>',
